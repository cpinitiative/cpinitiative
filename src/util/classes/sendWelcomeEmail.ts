...
export function sendWelcomeEmail({
  ...
  const placeholders = {
    ...
    welcome_text:
      classLevel === "beginner"
        ? `You've been registered for the Competitive Programming Initiative's Beginner USACO Class! Our class will be nine weeks long, starting on September 16, 2023, and ending on November 11, 2023. We'll meet every Sunday from 4 PM to 6 PM PDT.`
        : `You've been registered for the Competitive Programming Initiative's Intermediate USACO Class! Our class will be nine weeks long, starting on September 17, 2023, and ending on November 12, 2023. We'll meet every Saturday from 6 PM to 8 PM PDT.`,
    join_lms_text:
      classLevel === "beginner"
