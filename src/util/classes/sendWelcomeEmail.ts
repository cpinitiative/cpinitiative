...
export function sendWelcomeEmail({
  ...
  const placeholders = {
    ...
    welcome_text:
      classLevel === "beginner"
        ? `You've been registered for the Competitive Programming Initiative's Beginner USACO Class! Our class will be ten weeks long, starting on October 4th, 2026, and ending on December 13th, 2026. We'll meet every Sunday from 5 PM to 7 PM PDT.`
        : `You've been registered for the Competitive Programming Initiative's Intermediate USACO Class! Our class will be ten weeks long, starting on October 3rd, 2026, and ending on December 12th, 2026. We'll meet every Saturday from 4 PM to 6 PM PDT.`,
    join_lms_text:
      classLevel === "beginner"
