...
export function sendWelcomeEmail({
  ...
  const placeholders = {
    ...
    welcome_text:
      classLevel === "beginner"
        ? `You've been registered for the Competitive Programming Initiative's Beginner USACO Class! Our class will be ten weeks long, starting on June 28th, 2026, and ending on August 30th, 2026. We'll meet every Sunday from 5 PM to 7 PM PDT.`
        : `You've been registered for the Competitive Programming Initiative's Intermediate USACO Class! Our class will be ten weeks long, starting on June 27th, 2026, and ending on August 29th, 2026. We'll meet every Saturday from 4 PM to 6 PM PDT.`,
    join_lms_text:
      classLevel === "beginner"
