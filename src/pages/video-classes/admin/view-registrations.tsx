...
export default function ViewRegistrationPage() {
  ...
  const [registrationsIncludingDeleted, setRegistrations] = useState([])
                ...
                <div className="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                  ...
                  <button
                    ...
                    onClick={() => {
                      if (
                        confirm(
                          "Delete registration? This can't be reversed (easily). Also, this does not (yet) remove join links"
                        )
                      ) {
                        firebase
                          .firestore()
