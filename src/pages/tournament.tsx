            ...
            <div className="flex flex-col lg:mb-16 mt-6 lg:mt-12">
              ...
              <div className="flex flex-col items-stretch  ml-auto mr-auto">
                <div className="flex w-full justify-around gap-x-2 mx-auto">
                  <Link
                    className="text-center flex-grow mx-auto text-white bg-[#8976ff]/100 rounded-lg focus:translate-y-1 hover:underline transition-all duration-150 mt-4 lg:text-xl px-8 py-2"
                    href="/tournament/2024-results"
                  >
                    Results &rarr;
                  </Link>
                  <Link
                    className="mx-auto text-white bg-[#8976ff]/40 rounded-lg focus:translate-y-1 hover:underline transition-all duration-150 mt-4 lg:text-xl px-8 py-2"
                ...
                <div className=" flex justify-around gap-x-2 w-fit mx-auto my-2">
                  <Link
                    ...
                    className="bg-[#8976FF]/60 text-white z-10 w-fit mx-auto px-6 py-2 lg:text-xl text-lg rounded-lg"
                  >
                    View Editorial &rarr;
                  </Link>
                  <Link
                    href={"/" + CONTEST_SOLUTIONS_FILE}
                    className="bg-[#8976FF]/80 text-white z-10 w-fit mx-auto px-6 py-2 lg:text-xl text-lg rounded-lg"
                  >
            ...
            <div className="mx-8 w-full">
              <div className="mx-8  ">
                <div className="bg-[#EBE7FF]  px-8 text-center md:text-2xl text-xl py-6  rounded-lg">
                  <span className="font-bold">Only precollege students</span>{" "}
                  are eligible for prizes but anyone can participate. <br />
                  <br />
                ...
                <FAQCard
                  ...
                  answer={
                    <>
                      ...
                      online content published prior to the start of the
                      contest.
                      <br />
                      <br />
                      However, you <b className="text-[#7544FF]">
                        may not
                      </b>{" "}
