  ...
  return (
    <Layout>
      ...
      <main className="min-h-screen">
        ...
        <h1 className="text-center text-3xl md:text-4xl lg:text-5xl font-extrabold tracking-tight bg-gradient-to-br from-purple-400 to-blue-600 bg-clip-text text-transparent">
          Prizes
        </h1>
        <section className="flex flex-col bg-white md:flex-row justify-evenly mx-auto px-6 md:px-12 xl:px-36 lg:px-24 lg:gap-x-12 gap-x-6 md:gap-x-8">
          <Card
            key={"standard"}
            className="md:basis-1/2 border-0 bg-gradient-to-tr to-[#83a0f9] from-[#113399] from-10% via-80% to-90%"
            division="standard"
          />
          <Card
            key={"advanced"}
            className="md:basis-1/2 border-0 bg-gradient-to-tr from-[#6a5cbf] to-[#8570FA]/40"
            division="advanced"
          />
        </section>
        <section className="flex items-center container mx-auto text-justify px-6 bg-white flex-col">
          <h2 className="text-3xl md:text-4xl lg:text-5xl pb-6 mt-12 tracking-tight font-extrabold bg-gradient-to-tr from-blue-400 to-purple-600 bg-clip-text text-transparent">
            Contest Format & Rules
          </h2>
          <p className="text-xl lg:text-2xl py-4">
            <span className="font-bold italic">Only precollege students</span>{" "}
            are eligible for prizes but anyone can participate.{" "}
            <span className="font-bold italic">
              This is a solo contest. No teams!
            </span>
          </p>
          <p className="text-xl lg:text-2xl py-4">
            There will be both a standard and advanced division; the contest
            will last 3 hours and each division will have 8 problems.
          </p>
          <p className="text-xl lg:text-2xl py-4">
            If you are 1600+ on Codeforces OR Gold+ in USACO we require you to
            participate in the advanced division. Otherwise we recommend you to
            participate in the beginner division.
          </p>
          <p className="text-xl lg:text-2xl py-4">
            You may use any prewritten code before the contest and online
            content published prior to the start of the contest. However, you
            may not collaborate with other people during the contest.
          </p>
          <p className="text-xl lg:text-2xl py-4">
          ...
          <p className="py-4 text-xl lg:text-2xl font-bold">
            ...
            divisions with problem difficulties that are too low for the skill
            level of the participant. We do not tolerate those who attempt to
            undermine the fairness of the competition.
          </p>
        </section>
        <h2 className="text-xl lg:text-3xl text-5xl text-center font-extrabold py-6 tracking-tight">
          Questions? Join our
