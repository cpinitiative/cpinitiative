  ...
  return (
    <Layout>
      ...
      <div className="bg-gray-100">
        ...
        <div className="bg-purple-900 sm:-mb-8">
          ...
          <div className="max-w-screen-xl px-4 sm:px-6 mx-auto sm:-mb-8">
            ...
            <p className="mt-6 mb-6 text-purple-200 text-xl">
              We promote competitive programming among students through
              resources, classes, outreach, and contests.
            </p>
          </div>
          <svg
        ...
        <div className="bg-gray-100">
          <div className="bg-gray-100 -mt-1 max-w-screen-xl px-4 sm:px-6 mx-auto pb-12 sm:pb-16 flex flex-col md:flex-row">
            <div className="flex-[1_0_0px] items-stretch">
              ...
              <div className="grid grid-cols-1 gap-8 h-min grow-0" id="cards">
                ...
                <Card
                  ...
                  url="/classes"
                >
                  Learn USACO through high-quality classes with vetted,
                  experienced instructors and a curated curriculum.
                </Card>
                <Card title="Clubs" borderColor="border-green-600" url="/clubs">
                  Running a CP/CS club? Get access to curriculum, problemsets,
                  and contests tailored for school clubs!
                </Card>
                <Card
                  title="Contests"
                  ...
                  url="/contests"
                >
                  A selection of programming contests targeted towards
  ...
  const list = await Promise.all(
    data.map(async file => {
      const mdxSource = await serialize(
        fs.readFileSync("src/components/announcements/data/" + file),
