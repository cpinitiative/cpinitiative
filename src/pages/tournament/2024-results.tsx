    ...
    <Layout>
      ...
      <main className="min-h-screen">
        ...
        <section className="flex  flex-col lg:flex-row my-12 mx-12 sm:mx-24">
          ...
          <div className="md:basis-1/2 lg:mt-0 mt-8 text-center">
            <div className="text-2xl pb-2">
              1st place: Gimran Abdullin (bashkort)
            </div>
            ...
            <div className="text-lg">
              4th place: Eric Hsu (wavelets), 5th place: Rohin Garg
              (PurpleCrayon), 6th place: Hoàng Xuân Bách (bachbeo2007), 7th
              place: Alex Liang (sum), 8th place: Samuel Mo (IanISam)
            </div>
          </div>
        </section>
        <div className="w-full h-0.5 bg-gray-400/20 mb-12" />
        <section className="flex flex-col my-12 mx-12 sm:mx-24 reverse lg:flex-row-reverse">
          ...
          <div className="md:basis-1/2 lg:mt-0 mt-8 text-center">
            <div className="text-2xl pb-2">
              1st place (tie): <br /> Dwij Mehta (joesephdiver) & Robert Smith
              (myst-6_fan)
            </div>
            <div className="flex flex-col justify-center pb-1 text-xl">
              <div className="pr-4">
                2nd place: Kyle Liang (BearytheGreenBear) <br />
              </div>
              <div>3rd place: Husanboy Mansuraliyev (unimpossibler)</div>
            </div>
            <div className="text-lg">
              4th place: Ivan Li (Ivan_Li), 5th place: Brendon Wang (brendonw),
              6th place: Enmanuel Perez Martin (HorizonWest), 7th place: Miłosz
              Koczorowski (uped), 8th place: Dohun Kim (genius0412)
            </div>
          </div>
        </section>
        <div className="w-full h-0.5 bg-gray-400/20 mb-12" />
