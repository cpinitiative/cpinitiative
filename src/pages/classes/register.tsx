                        ...
                        {level == "beginner" ? (
                          <>
                            <p className="mt-2 text-sm text-gray-500">
                              ...
                              taught in this class will prepare students to pass
                              USACO Bronze and become USACO Silver contestants.
                            </p>
                            <i className="mt-2 text-sm text-gray-500">
                              Prerequisite: Basic Programming Experience in Java
                              or C++
                            </i>
                          </>
                        ) : (
                          <>
                            {" "}
                            <p className="mt-2 text-sm text-gray-500">
                              This course is designed for students currently in
                              USACO Silver. The topics taught in this class will
                              prepare students to pass USACO Silver and become
                              USACO Gold contestants.
                            </p>
                            <i className="mt-2 text-sm text-gray-500">
                    ...
                    <div className="shadow overflow-hidden sm:rounded-md">
                      <div className="px-4 py-5 bg-white sm:p-6">
                        <div className="grid grid-cols-6 gap-6">
                          <div className="col-span-6">
                            <label className="block text-sm font-medium text-gray-700">
                              How much financial aid are you requesting? Enter a
                              number between $1 and $100.
                            </label>
                            <p className="text-gray-500 mt-1 text-sm">
                              If you are only requesting partial financial aid,
                              you will not be required to pay unless your
                          ...
                          <div className="col-span-6">
                            ...
                            >
                              ...
                              taking this CPI course benefit you? (Max 250
                              words)
                            </label>
                            <textarea
                              rows={6}
                        ...
                        <div className="flex items-start">
                          ...
                          <div className="ml-3 text-sm">
                            <label className="font-medium text-gray-700">
                              I understand that my registration in this class is
                              not guaranteed, and that the Competitive
                              Programming Initiative will review my application
                              and decide whether or not to grant me a spot based
                              on demonstrated need and merit.
                            </label>
                          </div>
                        </div>
                    ...
                    <div className="px-4 py-5 bg-white space-y-6 sm:p-6">
                      ...
                      {(!hasAttemptedPayment || (level && dataIsValid)) && (
                        <>
                          ...
                          <p className="mt-1 text-sm text-gray-600">
                            Returns: If you are not satisfied with our classes,
                            you may cancel your class registration anytime
                            before the <b>second</b> class for a partial refund
                            of <b>$90</b> by emailing{" "}
                            <a
