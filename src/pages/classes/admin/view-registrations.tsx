...
export default function ViewRegistrationPage() {
  ...
  const {
    ...
    loading: isLoading,
  } = useClassRegistrations<LiveClassRegistration>("2026june", soundOn)
  ...
  const handleGrantFinancialAid = () => {
    ...
    currentUser
      .getIdToken()
      .then(idToken => {
        if (!detailModalRegistrationData)
      ...
      <div className="pt-4 sm:pt-10 text-center sm:text-left px-10 bg-gray-100 pb-10">
        <div className={"max-w-3xl mx-auto"}>
          ...
          <p className={"my-4"}>
            ...
            &middot;{" "}
            <a
              onClick={() => exportLiveRegistrations(registrations)}
              className={"text-blue-600 hover:underline pt-4 cursor-pointer"}
            >
              ...
              <div className="text-center sm:text-left w-full">
                <div className="mt-2">
                  ...
                  <p className=" text-gray-900">
                    ...
                    {moment(
                      new Date(detailModalRegistrationData.timestamp.toMillis())
                    ).format("M/D/YY h:mm:ss A")}
                  </p>
                  <p className=" text-gray-900">
                    <b>Financial Aid:</b>{" "}
                    {detailModalRegistrationData.financialAid ? "Yes" : "No"}
                  </p>
                  ...
                  {detailModalRegistrationData.financialAid && (
                    <div className="my-2">
                      <p className="text-gray-900">
                        <b>
                          Why are you interested in this course? How will taking
                          this CPI course benefit you?
                        </b>
                      </p>
                      <p className="text-gray-600">
                        {`(${
                  ...
                  <p className=" text-gray-900">
                    <b>Level:</b>{" "}
                    {detailModalRegistrationData.level.charAt(0).toUpperCase() +
                  ...
                  {["google", "other"].includes(
                    ...
                    <p className=" text-gray-900">
                      ...
                      {detailModalRegistrationData.personalInfo.referrerDetail}
                    </p>
                  )}
                  <p className=" text-gray-900">
                    <b>Timezone:</b>{" "}
                    {detailModalRegistrationData.personalInfo.timezone} (UTC
                    {moment
                      .tz(
                        moment.utc(),
