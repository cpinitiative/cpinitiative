...
export default function Card({ title, borderColor, children, url, external }: {
  title: string;
  borderColor: string;
  ...
  let contents = (
    <>
      <h2 className="font-medium text-2xl mb-2">
        {title}
        {url !== null && external && (
          <svg className="w-6 h-7 pb-1 inline-block text-gray-400 ml-2" fill="none" stroke="currentColor"
