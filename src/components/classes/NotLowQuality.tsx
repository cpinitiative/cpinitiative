    ...
    <div className="bg-purple-900 py-16 sm:py-20 px-4 sm:px-6">
      <div className="mx-auto max-w-prose text-lg">
        ...
        <div className="text-purple-200">
          ...
          <p className="mb-4">
            While our instructors freely volunteer their time to help teach these classes, we ask that students donate $100 to help fund the infrastructure costs of creating these classes ($10.41/hr). Of course, if you're unable to pay, you'll get access to these classes <b>for free</b>.
          </p>
          <p>
