            ...
            <div className="sm:text-center lg:text-left lg:col-span-2">
              ...
              <h2 className="text-4xl tracking-tight leading-10 font-extrabold text-gray-900 sm:text-5xl sm:leading-none md:text-6xl">
                <span className="text-blue-600">
                  USACO Open 2023 Contest Solutions
                </span>
              </h2>
              ...
              <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:text-xl lg:mx-0">
                Zoom Link:
                https://us06web.zoom.us/j/82283269766?pwd=UzFkRGZLWnFtUFlROXJBVFdoVzdrdz09
              </p>
              <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:text-xl lg:mx-0">
                Meeting ID: 822 8326 9766 Passcode: 114824
              </p>
              <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                <div className="rounded-md shadow">
                  <a
                    href="https://forms.gle/j6nHkgGfGbJqdjN57"
                    target="_blank"
