      ...
      <div className="mx-auto py-12 px-4 max-w-screen-xl sm:px-6 lg:px-8 lg:py-24">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-3 lg:gap-8">
          <div className="space-y-5 sm:space-y-4">
            <h2 className="text-3xl leading-9 font-extrabold tracking-tight sm:text-4xl">Meet the speakers</h2>
            <p className="text-xl leading-7 text-gray-500">This webinar will be hosted by top USACO contestants and USACO Finalists, with ample experience in competitive programming.</p>
          </div>
                  ...
                  <div className="flex items-center space-x-4 lg:space-x-6">
                    <div className="flex-shrink-0 w-16 h-16 rounded-full lg:w-20 lg:h-20">
                      <Img
                        ...
                        fixed={(data as any).allFile.edges.find(
                    ...
                    <div className="font-medium text-lg leading-6 space-y-1">
                      <h3>{member.name}</h3>
                      {member.title && <p className="text-indigo-600 text-base">{member.title}</p>}
                    </div>
                  </div>
                </li>
              ))}
