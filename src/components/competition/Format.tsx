  ...
  return (
    <div className="bg-white">
      ...
      <div className="flex flex-col mb-8">
          <p className="tracking-tight text-center font-xs text-purple-600 font-semibold uppercase">1st place in Div. 1 or 2</p>
          <h2 className="flex justify-center font-extrabold tracking-tight text-4xl mb-6">
            Prizes
          </h2>
      ...
      <p className="text-center font-xs text-purple-600 font-semibold uppercase">Questions?</p>
      <p className="text-center prose max-w-full">Ping <strong>Pranav#7895</strong> in the CPI Discord!</p>
    </div>
  )
}
